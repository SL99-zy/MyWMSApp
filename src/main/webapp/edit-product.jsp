...
window.location.href = <%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <div class="product-section">
        ...
        <div class="action-buttons">
            <div class="action-buttons-grid">
                <button type="button" class="action-btn edit-btn" onclick="editProduct('<%= product.getBarcode() %>')">
...
<script>
    ...
    // Edit product function (placeholder for future implementation)
    function editProduct(barcode) {
